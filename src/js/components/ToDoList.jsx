    ...
    <div className='container my-3 text-start'>
      <div className='row'>
        <div className='col-10 col-sm-8 col-md-6 m-auto'>
          <h1 className='text-primary'>Tareas por hacer</h1>
          <form onSubmit={handleOnSubmit}>
            <div className="mb-3">
              <label htmlFor="input1" className="form-label">Nueva tarea</label>
              <input type="text" className="form-control" id="input1" placeholder="Agrega tarea"
